...
if st.session_state.page == "home":
    ...
    subjects = [
        {"emoji": "🤖", "name": "Robootika",        "color": "#7c3aed", "light": "#ede9fe", "desc": "Robotid, andurid, projektid"},
        {"emoji": "💻", "name": "Programmeerimine", "color": "#0ea5e9", "light": "#e0f2fe", "desc": "Python, Scratch, algoritmid"},
        {"emoji": "🔢", "name": "Matemaatika",       "color": "#d97706", "light": "#fef3c7", "desc": "algebra, geomeetria, statistika"},
        {"emoji": "⚡", "name": "Füüsika",            "color": "#dc2626", "light": "#fee2e2", "desc": "Elekter, jõud, energia"},
        {"emoji": "🧪", "name": "Keemia",             "color": "#059669", "light": "#d1fae5", "desc": "Elemendid, reaktsioonid"},
        {"emoji": "🌱", "name": "Loodusõpetus",      "color": "#16a34a", "light": "#dcfce7", "desc": "Ökosüsteemid, keskkond"},
    ]
    ...
    for i, subj in enumerate(subjects):
        with cols[i % 3]:
            ...
            """, unsafe_allow_html=True)
            if st.button(f"Küsi {subj['name']} kohta", key=f"subj_{i}"):
                st.session_state.messages.append({
                    "role": "user",
                    "content": f"Räägi mulle {subj['name']} kohta – mis on peamised teemad ja kuidas sa saad aidata?"
                })
    ...
    suggested = [
        "🤖 Kuidas programmeerida robotit Pythoniga?",
        "🔢 Seleta mulle Pythagorase teoreemi",
        "⚡ Mis on elektrivool ja kuidas see töötab?",
        "💻 Kuidas teha oma esimene programm Scratchis?",
...
# ─────────────────────────────────────────────
    ...
    if len(st.session_state.messages) <= 1:
        ...
        quick = ["Mis on Python?", "Seleta robootika aluseid", "Aita matemaatikas"]
        qcols = st.columns(3)
